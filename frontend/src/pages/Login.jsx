                ...
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    ...
                    >
                        ...
                        <button
                            ...
                            className={`w-full px-4 py-2 text-white font-medium rounded-lg ${isSigningIn ? 'bg-gray-300 cursor-not-allowed' : ' medium-15 border border-blue-500 bg-blue-500 px-7 py-3 text-white transition-all hover:bg-blue-700 rounded-full'}`}
                        >
